...
Текущий результат: 55 тестов, покрытие 97,64%; минимальный порог покрытия — 97%.
...
остатков по филиалам. Система явно сообщает об отсутствии данных. Она формирует
рекомендации по закупке, но не отправляет заказы поставщикам: интеграция с
закупочной системой и процесс подтверждения заказа выходят за рамки MVP.
